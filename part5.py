...
if month == 'September' or month == 'september' or month == 'June' or month == 'june' or month == 'April' or month == 'april' or month == 'November' or month == 'november': 
 print ("30")
   ...
   print ("28 or 29")
else: #linkedtolatestifstatement
 print ("not a month")